...
#Practica 2. Uso de API con bucle.
...
#En este caso se plantean varios angulos, y se obtiene el desplazamiento U1 en el apoyo no concordante para cada angulo
...
l_pilar_2 = 2   #Longitud de pilar_2
l_viga = 10     #Longitud de viga
elast = 2.1E8   #Módulo de elasticidad en kN / m^2

ang = 0         # Ángulo inicial

angulos = [10,15,30,40,50,60,62,65,70,74.5] #Lista de ángulos a verificar. 
...
if not os.path.exists(APIPath):
 try:
     ...
     pass
err = ModeloSap.File.Save(APIPath + os.sep + 'Practica2_API_Python_bucle.sdb')
...
#Paso 19.
#Bucle para iterar entre los diferentes angulos
#==============================================
for ang in angulos:
    # En primer lugar, se desbloquea el modelo, ya que tras correr el análisis, el modelo queda bloqueado. 
    err = ModeloSap.SetModelIsLocked(False)

    # A continuación se cambia el sistema de referencia nodal.
    alfa = -ang;
    err = ModeloSap.PointObj.SetLocalAxes(PointName2,0,alfa,0,0)
    err = ModeloSap.Analyze.RunAnalysis()
...
#Fin de bucle: cierre del programa
